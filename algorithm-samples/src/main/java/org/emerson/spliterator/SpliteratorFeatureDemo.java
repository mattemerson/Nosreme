...
/**
 * {@link https://www.geeksforgeeks.org/java-util-interface-spliterator-java8/}
 * @author memerson
 *
 */
public class SpliteratorFeatureDemo {
    ...
    public static void main(String[] args)
    {
        ...
        // trySplit() method
        // In this case, it will try to split things in half...this would be useful for parallel computing!
